...
package io.github.vampirestudios.raa_dimension.fabric.impl;
...
public final class DimensionRenderingRegistryImpl implements DimensionRenderingRegistry {
	...
	private final Map<RegistryKey<World>, DimensionRenderingRegistry.SkyRenderer> SKY_RENDERERS = new IdentityHashMap<>();
	...
	@Override
	public SkyProperties getSkyProperty(RegistryKey<DimensionType> key) {
