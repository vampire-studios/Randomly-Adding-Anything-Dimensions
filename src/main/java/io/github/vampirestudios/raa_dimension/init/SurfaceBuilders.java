...
public class SurfaceBuilders {
    ...
    public static void init() {
        DARK_BADLANDS = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "dark_badlands"),
                new DarkBadlandsSurfaceBuilder(TernarySurfaceConfig.CODEC));

        PATCHY_DESERT = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "patchy_desert"),
                new PatchyDesertSurfaceBuilder(TernarySurfaceConfig.CODEC));
        PATCHY_BADLANDS = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "patchy_badlands"),
                new PatchyBadlandsSurfaceBuilder(TernarySurfaceConfig.CODEC));
        DARK_PATCHY_BADLANDS = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "dark_patchy_badlands"),
                new PatchyDarkBadlandsSurfaceBuilder(TernarySurfaceConfig.CODEC));
        CLASSIC_CLIFFS = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "classic_cliffs"),
                new ClassicCliffsSurfaceBuilder(TernarySurfaceConfig.CODEC));
        STRATIFIED_CLIFFS = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "stratified_cliffs"),
                new StratifiedSurfaceBuilder(TernarySurfaceConfig.CODEC));
        FLOATING_ISLANDS = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "floating_islands"),
                new FloatingIslandSurfaceBuilder(TernarySurfaceConfig.CODEC));
        DUNES = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "dunes"),
                new DuneSurfaceBuilder(TernarySurfaceConfig.CODEC));
        SANDY_DUNES = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "sandy_dunes"),
                new SandyDunesSurfaceBuilder(TernarySurfaceConfig.CODEC));
        LAZY_NOISE = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "lazy_noise"),
                new LazyNoiseSurfaceBuilder(TernarySurfaceConfig.CODEC));
        HYPER_FLAT = Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(RAADimensionAddon.MOD_ID, "hyper_flat"),
