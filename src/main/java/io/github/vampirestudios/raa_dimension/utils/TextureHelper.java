...
public class TextureHelper {
	...
	public static ResourceLocation makeBlockTextureID(String name) {
		return RAADimensionAddon.id("block/" + name);
	}
	
	public static ResourceLocation makeItemTextureID(String name) {
		return RAADimensionAddon.id("item/" + name);
	}

	public static ResourceLocation makeArmorTextureID(String name) {
		return RAADimensionAddon.id("models/misc/armor/" + name);
	}
	...
	public static NativeImage loadImage(ResourceLocation name) {
		try {
			Resource input = Minecraft.getInstance().getResourceManager().getResourceOrThrow(Utils.appendAndPrependToPath(name, "textures/", ".png"));
	...
	public static NativeImage loadImage(String name) {
		try {
			ResourceLocation id = RAADimensionAddon.id(name);
