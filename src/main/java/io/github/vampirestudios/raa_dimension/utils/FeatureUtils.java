...
public class FeatureUtils {
    ...
    public static void setSpawner(ServerWorldAccess world, BlockPos pos, EntityType<?> entity) {
    ...
    public static void setLootChest(ServerWorldAccess world, BlockPos pos, Identifier lootTable, Random rand) {
