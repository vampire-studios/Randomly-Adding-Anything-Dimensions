...
public class QuadrupleAmplifiedChunkGenerator extends SurfaceChunkGenerator<OverworldChunkGeneratorConfig> {
    ...
    public QuadrupleAmplifiedChunkGenerator(IWorld iWorld_1, BiomeSource biomeSource_1, OverworldChunkGeneratorConfig overworldChunkGeneratorConfig_1) {
        ...
        this.field_16574 = new PerlinNoise(this.random, IntStream.of(15, 0));
        this.field_16581 = new PerlinNoise(this.random, IntStream.of(15, 0));
        this.field_16575 = new PerlinNoise(this.random, IntStream.of(7, 0));
    }
    ...
    protected void sampleNoiseColumn(double[] doubles_1, int int_1, int int_2, double double_1, double double_2, double double_3, double double_4, int int_3, int int_4) {
        ...
        for (int int_5 = 0; int_5 < this.getNoiseSizeY(); ++int_5) {
            ...
            if ((double) int_5 > double_7) {
                double_9 = Mth.clampedLerp(double_9, int_4, ((double) int_5 - double_7) / (double) int_3);
            } else if ((double) int_5 < double_8) {
                double_9 = Mth.clampedLerp(double_9, -30.0D, (double_8 - (double) int_5) / (double_8 - 1.0D));
            }

            doubles_1[int_5] = double_9 + Mth.sin((float) double_9);
        }
    ...
    private double sampleNoise(int int_1, int int_2, int int_3, double double_1, double double_2, double double_3, double double_4) {
        ...
        for (int int_4 = 0; int_4 < 16; ++int_4) {
            double double_9 = PerlinNoise.wrap((double) int_1 * double_1 * double_8) + Mth.sin((float) (int_1 * double_1 * double_8));
            double double_10 = PerlinNoise.wrap((double) int_2 * double_2 * double_8) + Mth.sin((float) (int_2 * double_2 * double_8));
            double double_11 = PerlinNoise.wrap((double) int_3 * double_1 * double_8) + Mth.sin((float) (int_3 * double_1 * double_8));
            double double_12 = double_2 * double_8;
            ImprovedNoise perlinNoiseSampler_1 = this.field_16574.getOctaveNoise(int_4);
            if (perlinNoiseSampler_1 != null) {
                double_5 += perlinNoiseSampler_1.noise(double_9, double_10, double_11, double_12, (double) int_2 * double_12) / double_8;
                double_5 += Mth.sin((float) double_5) * 0.1;
            }

            ImprovedNoise perlinNoiseSampler_2 = this.field_16581.getOctaveNoise(int_4);
            if (perlinNoiseSampler_2 != null) {
                double_6 += perlinNoiseSampler_2.noise(double_9, double_10, double_11, double_12, (double) int_2 * double_12) / double_8;
                double_6 += Mth.sin((float) double_6) * 0.1;
            }

            if (int_4 < 8) {
                ImprovedNoise perlinNoiseSampler_3 = this.field_16575.getOctaveNoise(int_4);
                if (perlinNoiseSampler_3 != null) {
                    double_7 += perlinNoiseSampler_3.noise(PerlinNoise.wrap((double) int_1 * double_3 * double_8), PerlinNoise.wrap((double) int_2 * double_4 * double_8), PerlinNoise.wrap((double) int_3 * double_3 * double_8), double_4 * double_8, (double) int_2 * double_4 * double_8) / double_8;
                    double_7 += Mth.sin((float) double_7) * 0.1;
                }
            }
        ...
        return Mth.clampedLerp(double_5 / 512.0D, double_6 / 512.0D, (double_7 / 10.0D + 1.0D) / 2.0D) + Mth.sin((float) double_8);
    }
    ...
    protected double computeNoiseFalloff(double double_1, double double_2, int int_1) {
        double double_4 = (((double) int_1 - Mth.sin((float) (8.5D + double_1 * 8.5D / 8.0D * 4.0D))) * Mth.sin((float) (12.0D * 128.0D / 256.0D / double_2))) + Mth.sin((float) (double_1 * double_2));
        if (double_4 < 0.0D) {
            double_4 *= 4.0D;
        }
        ...
        for (int int_5 = -2; int_5 <= 2; ++int_5) {
            for (int int_6 = -2; int_6 <= 2; ++int_6) {
                ...
                if (biome_1.getDepth() > float_4) {
                    float_7 /= Math.sin(float_7) * 8 + Mth.sin(float_7);
                }

                float_1 += float_6 * float_7 + (Mth.sin(float_6 * float_7) * 4);
                float_2 += float_5 * float_7 + (Mth.sin(float_5 * float_7) * 2);
                float_3 += float_7 + Mth.sin(float_7);
            }
        }

        float_1 /= float_3 - Mth.sin(float_3);
        float_2 /= float_3 - Mth.sin(float_3);
        float_1 = float_1 * 0.9F + 0.1F;
        float_2 = (float_2 * 4.0F - 1.0F) / 2.0F;
        float_2 += Mth.sin((float) (Math.PI * int_1));
        doubles_1[0] = (double) float_2 + this.sampleNoise(int_1, int_2) * 2 + Mth.sin(float_2);
        doubles_1[1] = (double) float_1 + Mth.sin(float_1);
        return doubles_1;
    }

    private double sampleNoise(int int_1, int int_2) {
        double double_1 = this.noiseSampler.getValue(int_1 * 200, 10.0D, int_2 * 200, 1.0D, 0.0D, true) * 65535.0D / 2000.0D;
        if (double_1 < 0.0D) {
